...
CREATE INDEX idx_vendor_services_location ON vendor_services(location);
CREATE INDEX idx_vendor_services_availability ON vendor_services(availability);
CREATE INDEX idx_vendor_services_is_active ON vendor_services(is_active);
CREATE INDEX idx_vendor_services_is_online ON vendor_services(is_online);
CREATE INDEX idx_vendor_services_created_at ON vendor_services(created_at);

-- Composite Indexes for Common Queries
CREATE INDEX idx_vendor_services_vendor_active ON vendor_services(vendor_id, is_active);
CREATE INDEX idx_vendor_services_service_location ON vendor_services(service_id, location);
CREATE INDEX idx_vendor_services_vendor_online ON vendor_services(vendor_id, is_online);
...
CREATE INDEX idx_vendor_service_reviews_vendor_service ON vendor_service_reviews(vendor_service_id);
CREATE INDEX idx_vendor_service_reviews_user ON vendor_service_reviews(user_id);
CREATE INDEX idx_vendor_service_reviews_rating ON vendor_service_reviews(rating);
CREATE INDEX idx_vendor_service_reviews_created_at ON vendor_service_reviews(created_at);
...
CREATE INDEX idx_vendor_service_availability_vendor_service ON vendor_service_availability(vendor_service_id);
...
WHERE vs.is_active = TRUE AND v.status = 'approved';
